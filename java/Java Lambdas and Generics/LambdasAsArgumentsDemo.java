...
class LambdasAsArgumentsDemo {
    ...
    // its first parameter. Thus, it can be passed a s a reference to
    ...
    public static void main(String args[]) {
        ...
        outStr = stringOp((str) -> str.toUpperCase(), inStr); // ? instance use case 1
        System.out.println("The string in uppercase: " + outStr);

        // This passes a block lambda that removes spaces.
        outStr = stringOp((str) -> {  // ? instance use case 2
            String result = "";
            int i;
        ...
        StringFunc reverse = (str) -> { // ? instance use case 3
            String result = "";
            int i;
        ...
        System.out.println("The string reversed: " + reverse.func(inStr));
    }
}
