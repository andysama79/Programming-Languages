// use an instance method refernce with different objects

// Afunctional interface that takes two reference arguments
...
public class InstanceMthodWithObjectRefDemo {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(count + " days had a high og 12");
